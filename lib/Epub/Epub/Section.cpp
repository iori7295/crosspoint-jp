...
constexpr uint8_t SECTION_FILE_VERSION = 102;
// v100: post-fork consolidation — readString cap, heap-allocated advance buf,
//       single‑overflow word guard.  Previous v32/v33 files are invalidated.
...
bool Section::loadSectionFile(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
                               ...
                               const uint8_t imageRendering, const bool focusReadingEnabled, const bool verticalMode,
                               const uint8_t charSpacing) {
  ...
  // Match parameters
  {
    ...
    bool fileVerticalMode = false;
    uint8_t fileCharSpacing = 0;
